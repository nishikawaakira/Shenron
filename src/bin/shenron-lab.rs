...
fn print_coverage(report: &CoverageReport) {
    ...
    println!("\nLog detectability:\nHIGH:                        {}\nMEDIUM:                      {}\nLOW:                         {}\nUNDETECTABLE:                {}\nUNKNOWN:                     {}\n\nConversion:\nConvertible in principle:    {}\nSupported by Shenron:        {}\nUnsupported by Shenron:      {}\n\nSynthetic validation:\nTemplates tested:            {}\nSynthetic events generated:  {}\nExpected detections:         {}\nCorrect detections:          {}\nMissed detections:           {}\nUnexpected matches:          {}\nMutation cases:              {}\nMutation failures:           {}\nNear-miss cases:             {}\nNear-miss failures:          {}", coverage.high, coverage.medium, coverage.low, coverage.undetectable, coverage.unknown, coverage.convertible_in_principle, coverage.supported_by_shenron, coverage.unsupported_by_shenron, coverage.templates_tested, coverage.synthetic_events_generated, coverage.expected_detections, coverage.correct_detections, coverage.missed_detections, coverage.unexpected_matches, coverage.mutation_cases, coverage.mutation_failures, coverage.near_miss_cases, coverage.near_miss_failures);
}
